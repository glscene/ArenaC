...
#ifndef fProjectionsH
#define fProjectionsH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFormProjections : public TForm
{
...
public:		// User declarations
	__fastcall TFormProjections(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TFormProjections *FormProjections;
//---------------------------------------------------------------------------
#endif
